...
public class CustomerController {
    ...
    public ResponseEntity<Boolean> existsWithId(@PathVariable("customer-id") String customerId){
        return ResponseEntity.ok(service.existsById(customerId));
    }

    @GetMapping("/{customer-id}")
    public ResponseEntity<CustomerResponse> findWithId(@PathVariable("customer-id") String customerId){
